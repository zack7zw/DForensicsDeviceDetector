...
public class LoadModel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inceptionFloat = (Button)findViewById(R.id.uploadImage);
        inceptionFloat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // filename in assets
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == REQUEST_IMAGE && resultCode == RESULT_OK) {
            try {
                ...
                Crop.of(source_uri, dest_uri).asSquare().start(LoadModel.this);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        // if cropping acitivty is finished, get the resulting cropped image uri and send it to 'Classify' activity
            ...
            Intent i = new Intent(LoadModel.this, Classify.class);
